...
router.post('/', auth, authrequireInstructor ,upload.single('image') , courseController.createCourse)
router.put('/:id',auth, authrequireInstructor,  upload.single('image'), courseController.updateCourse)
router.delete('/:id', auth, authrequireInstructor, courseController.deleteCourse)
